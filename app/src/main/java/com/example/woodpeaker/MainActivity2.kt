    ...
    fun btn(){
        RealtimeDatabaseDao.reference.addValueEventListener(object: ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                FcmNotificationSend(value,"WoodPeaker","New Order Arrived! Check Now",this@MainActivity2)

            }
            override fun onCancelled(error: DatabaseError) { Log.w("TAG", "Failed to read value.", error.toException()) }
        })
    }
}
